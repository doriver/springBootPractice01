...
//    @PostMapping("/add")
    ...
    @PostMapping("/add") // Form전송 객체 분리한거( 저장, 수정 )
...
//    @PostMapping("/{itemId}/edit") // Form전송 객체 분리한거( 저장, 수정 )
    public String editV2(@PathVariable("itemId") Long itemId, @Validated @ModelAttribute("item") ItemUpdateForm form, BindingResult bindingResult) {
